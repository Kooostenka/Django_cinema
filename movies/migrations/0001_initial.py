    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tagline', models.CharField(max_length=100, verbose_name='Имя')),
                ('description', models.TextField(verbose_name='Описание')),
                ...
                ('budget', models.PositiveSmallIntegerField(default=0, help_text='указывать сумму в доллорах', verbose_name='Бюджет')),
                ('fees_in_usa', models.PositiveSmallIntegerField(default=0, help_text='указывать сумму в доллорах', verbose_name='Сборы в США')),
                ('fees_in_world', models.PositiveSmallIntegerField(default=0, help_text='указывать сумму в доллорах', verbose_name='Сборы в США')),
                ...
                ('genres', models.ManyToManyField(related_name='film_actor', to='movies.Genre', verbose_name='актеры')),
            ],
            options={
                'verbose_name': 'Фильм',
